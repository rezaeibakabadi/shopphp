...
<div class=\"col-md-3 col-sm-6 my-3 my-md-0\" style='padding: 8px 8px;'>
            <form action=\"index.php\" method=\"post\">
                <div class=\"card shadow\">
                    <div>
                        <img src=\"$productimg\" alt=\"Image1\" class=\"img-fluid card-img-top\" style=\"padding: 4px 4px; width: 230px;height: 230px;\">
                </div>
                    <div class=\"card-body\">
                        ...
                        <h5><hr>
                            ...
                            <small><s class=\"text-secondary\">$producprice  ریال</s></small>
                            <br>
                            <span class=\"price\">  ریال 
                              $producprice 
                    ...
                    <div class=\"border rounded\">
                        <div class=\"row bg-white\" style='border-radius: 5px;'>
                            ...
                            <div class=\"col-md-6\" style='padding: 29px 29px;'>
                                ...
                                <small class=\"text-secondary\" style='font-size: 25px;'>قیمت فروش :</small>
                                <h5 class=\"pt-2\"> ريال $productprice </h5>
